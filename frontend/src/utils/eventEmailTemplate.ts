export interface EventoDataForTemplate {
  id: string;
  nombre: string;
  fecha_inicio: string;
  link_reunion?: string;
...
export function buildEventEmailTemplate(evento: EventoDataForTemplate): {
  id: string;
  name: string;
  subject: string;
  htmlContent: string;
...
<!-- Tarjeta de Detalles del Evento (Estilo Google Card) -->
...
<!-- Botón de Confirmación Directo a la Landing -->
